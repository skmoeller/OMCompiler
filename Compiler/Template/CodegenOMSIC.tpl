...
::=
  ...
  case SIMCODE(modelInfo=MODELINFO(__), makefileParams=MAKEFILE_PARAMS(__), simulationSettingsOpt = sopt) then
    ...
    LIBS = $(OMSU_STATIC_LIB) -Wl,-Bdynamic -l$(EXPAT_LIB) -l$(LAPACK_LIB) -l$(BLAS_LIB)  -l$(KINSOL_LIB) -l$(SUNDIALS_NVECSERIAL)
    ...
    '$(LAPACK_LIBDIR)/lib$(LAPACK_LIB).<%libEnding%>' else ''%>       \
     $(KINSOL_LIBDIR)/lib$(KINSOL_LIB).<%libEnding%>                                \
     $(KINSOL_LIBDIR)/lib$(SUNDIALS_NVECSERIAL).<%libEnding%>                       \
    ...
    <%\t%>cp -f $(THIRD_PARTY_DYNAMIC_LIBS) <%fileNamePrefix%>.fmutmp/binaries/<%makefileParams.platform%>
