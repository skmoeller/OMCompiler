...
::=
  match simCode
    ...
    /* Instantiate generated code */
    omsi_int instantiateOMSIC(omsi_t *omsi_data){
...
template createMakefile(SimCode simCode, String FileNamePrefix)
::=

  match simCode
  case SIMCODE(__) then

    let &sourceFiles = buffer""

    let &sourceFiles += FileNamePrefix + "_omsic.c"
  ...
  # Makefile generated by OpenModelica
    ...
    OMSI_LIBRARIES = -lOMSIBase -lOMSU -lOMSISolver
    OMSI_LIBRARIES_PATH = $(OPENMODELICAHOME)/../OMCompiler/build/lib/omc/omsi
