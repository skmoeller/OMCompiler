...
::=
  ...
  case SIMCODE(modelInfo=MODELINFO(__)) then
    ...
    #include <omsi.h>
    /*#include <<%modelNamePrefixStr%>_init_equations.h>*/
    #include <<%modelNamePrefixStr%>_sim_equations.h>
...
::=
  ...
  case SIMCODE(modelInfo=MODELINFO(__), makefileParams=MAKEFILE_PARAMS(__), simulationSettingsOpt = sopt) then
    ...
    #CFLAGS = <%makefileParams.cflags%>
    CXX=<%makefileParams.cxxcompiler%>
    LD=$(CC) -shared
    # LDFLAGS=@LDFLAGS@ @LIBS@

    RUNTIMELIBS = -LOMSIBase -LOMSIC -LOMSISolver
    ...
    RUNTIMEINCLUDES = -I$(OPENMODELICAHOME)/include/omc/omsi -I$(OPENMODELICAHOME)/include/omc/omsi/solver \
     -I$(OPENMODELICAHOME)/include/omc/omsi/fmi2 -I$(OMHOPENMODELICAHOMEME)/include/omc/omsic/
    ...
    all: $(OFILES)
    <%\t%>$(CC) $(CFLAGS) $(LIBSDIR) $(LIBS) -o $(OFILES) <%FileNamePrefix%>
