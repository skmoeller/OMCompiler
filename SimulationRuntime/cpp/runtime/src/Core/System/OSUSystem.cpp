...
{
    if ((_osu_me->solving_mode == omsi_continuousTime_mode) || (_osu_me->solving_mode == omsi_event_mode))
  {
        //write inputs
        //read outputs
...
void OSUSystem::writeOutput(const IWriteOutput::OUTPUT command)
{
  ...
  {
     const all_names_t outputVarNames = make_tuple(_real_vars.ourputVarNames,_int_vars.ourputVarNames,_bool_vars.ourputVarNames,_der_vars.ourputVarNames,_res_vars.ourputVarNames);
     const all_description_t outputVarDescription = make_tuple(_real_vars.ourputVarDescription,_int_vars.ourputVarDescription,_bool_vars.ourputVarDescription,_der_vars.ourputVarDescription,_res_vars.ourputVarDescription);
     const all_names_t parameterVarNames =  make_tuple(_real_vars.parameterNames,_int_vars.parameterNames,_bool_vars.parameterNames,_der_vars.ourputVarNames,_res_vars.ourputVarNames);
     const all_description_t parameterVarDescription =  make_tuple(_real_vars.parameterDescription,_int_vars.parameterDescription,_bool_vars.parameterDescription,_der_vars.ourputVarDescription,_res_vars.ourputVarDescription);
     _writeOutput->write(outputVarNames,outputVarDescription,parameterVarNames,parameterVarDescription);
     const all_vars_t params = make_tuple(_real_vars.outputParams,_int_vars.outputParams,_bool_vars.outputParams,_der_vars.outputParams,_res_vars.outputParams);
  ...
  else
  {
      ...
      all_vars_time_t all_vars = make_tuple(_real_vars.outputVars,_int_vars.outputVars,_bool_vars.outputVars,_simTime,_der_vars.outputVars,_res_vars.outputVars);
      neg_all_vars_t neg_all_vars =      make_tuple(_real_vars.negateOutputVars,_int_vars.negateOutputVars,_bool_vars.negateOutputVars,_der_vars.negateOutputVars,_res_vars.negateOutputVars);
