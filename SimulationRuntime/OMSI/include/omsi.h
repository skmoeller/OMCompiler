...
int omsi_initiatiate_osu(omsi_t** osi);
int omsi_initialize_model(omsi_t** osi);
int omsi_initialize_solver(omsi_t** osi);
int omsi_intialize_simulation(omsi_t** osi);
